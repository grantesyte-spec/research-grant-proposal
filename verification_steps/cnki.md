...
2. Do NOT start PubMed or Wanfang verification until CNKI is complete
3. Do NOT switch between databases mid-verification
4. Complete one database before moving to the next
